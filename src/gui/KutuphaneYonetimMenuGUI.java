...
public class KutuphaneYonetimMenuGUI extends JFrame {
    ...
    private final Color ACCENT_COLOR = new Color(230, 126, 34); // Turuncu Ton

    public KutuphaneYonetimMenuGUI() {
        setTitle("Kütüphane Yönetimi");
        setSize(800, 400); // 3 Kart olduğu için biraz daha geniş
        ...
        // Kartlar
        JPanel gridPanel = new JPanel(new GridLayout(1, 3, 20, 20)); // Yan yana 3 kart
